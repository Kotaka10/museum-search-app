...
export default function FilteredPrefecture({ filteredMuseums, prefecture}) {
    const size = 20;
    const [page, setPage] = useState(0);
    const [totalPages, setTotalPages] = useState(filteredMuseums.totalPages || 0);
    const [museums, setMuseums] = useState(filteredMuseums.content || []);
    ...
    useEffect(() => {
        ...
        if (prefecture) fetchMuseums();
    }, [prefecture, page, sortKey]);
