...
export default function FetchPhotoMuseums({ filteredPhotos, photo }) {
    const size = 20;
    const [page, setPage] = useState(0);
    const [totalPages, setTotalPages] = useState(filteredPhotos.totalPages || 0);
    const [museums, setMuseums] = useState(filteredPhotos.content || []);
